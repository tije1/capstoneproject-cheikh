...
public class CommonUtility extends BaseSetup {
    ...
    public void selectByIndex(WebElement ele, int string) {
    ...
    public void selectMonthByValue(WebElement ele, String monthValue) {
        Select select = new Select(ele);
    ...
    public void sendTextwithjs(WebElement element, String text) {
        JavascriptExecutor executor = (JavascriptExecutor) getDriver();
    ...
    public int countElementsByXPath(WebDriver driver, String xpath) {
